  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="al-fisio-clinica-de";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="AL Fisio Clínica de Fisioterapia y Readaptación"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="al-fisio-clinica-de"
          data-primary-color="#b6a77d"
          defer
        ></script>
      </head>
